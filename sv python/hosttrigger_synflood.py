...
tableid=13
value='SynFlood' # Connection classifier Value
...
class Trigger(HostTrigger):
    def trigger(self):
        ...
        if (json_obj['status'] != "ok"):
            ...
            send_trap("Syn flood threat detected on %s" % (self.distributed_field_list))
    ...
    def reset(self):
        ...
        if (json_obj['status'] != "ok"):
            ...
            send_trap("Syn flood clear on %s" % (self.distributed_field_list))
